...
public class ShoulderCamManager : MonoBehaviour
{
    ...
    [Tooltip("Kameraya eklediðiniz Cinemachine Camera Offset bileþenini buraya sürükleyin.")]
    ...
    [Tooltip("Karakterin omzuna hizalanacak offset mesafesi (X: Sað-Sol, Y: Yukarý-Aþaðý, Z: Ýleri-Geri)")]
    [SerializeField] private Vector3 shoulderOffset = new Vector3(0.6f, -0.2f, -0.8f);
    [Tooltip("Omza geçiþ ve eski haline dönme pürüzsüzlük süresi (Saniye)")]
    ...
    [Tooltip("Niþan alýrken mouse hýzýnýn ne kadar yavaþlayacaðý")]
    ...
    private void InitializeCameraValues()
    {
        ...
        // Eðer Inspector'dan sürüklemeyi unutursan kod otomatik bulsun
        ...
        else
        {
            ...
            Debug.LogWarning("CinemachineCameraOffset bileþeni bulunamadý! Lütfen CinemachineCamera'ya ekleyin.");
        }
    }
    ...
    private IEnumerator AimTransitionRoutine(Vector3 targetOffset, float targetFOV)
    {
        ...
        while (elapsed < lerpDuration)
        {
            ...
            // Yeni Offset bileþeni üzerinden lerp iþlemi
